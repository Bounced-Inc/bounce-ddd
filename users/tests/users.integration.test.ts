...
describe('User API Integration Tests', () => {
    ...
    describe('PATCH /users/:userId', () => {
        it('should update user fields partially', async () => {
            ...
            expect(updatedUser.body.firstName).toBe('UpdatedFirstName');
            expect(updatedUser.body.lastName).toBe('UpdatedLastName');
    ...
    describe('PUT /users/:userId', () => {
        it('should update all user fields', async () => {
            ...
            expect(getResponse.body.firstName).toBe('NewJane');
        });
